...
export const setPage = (num: number): ICarouselReduxAction => ({type: actionTypes.carousel.SET_PAGE, payload: num})
...
export const pageTo = (addToPage: number) => (dispatch:any, getState: any) => {
